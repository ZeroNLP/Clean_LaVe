...
def fine_tune_v3(args):
    ...
    n_dev = int(len(data)*0.2) # dev数量/home/jwwang/URE_EAE/NL/config/gen_label2id.py
    ...
    if config['warm_up_step'] >= 0:
        warm_up_steps = config['warm_up_step']
    ...
    for epoch in range(config['epoch']):
        ...
        if dev_acc>base_acc:
            base_acc = dev_acc
            print("save model to ",os.path.join(args.check_point_path))
...
if __name__=="__main__":
    ...
    parser.add_argument('--ratio', type=float,default=0.09)
    parser.add_argument('--check_point_path',type=str,default="",
                        help = "finetune好的模型保存到哪里")
    parser.add_argument("--config_path", type=str,default="/home/jwwang/URE_UEE/finetune/config/ace.json", help="as named")
